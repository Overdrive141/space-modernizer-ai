...
const Home: NextPage = () => {
  return (
    <div className="flex max-w-full mx-auto flex-col items-center justify-center py-2 min-h-screen">
      <Head>
        <title>DreamRoom AI - ControlNet</title>
      </Head>
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-20 mt-20 background-gradient">
        ...
        <Link
          className="border-2 border-red-800 bg-black rounded-xl text-white font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-red-900 shadow-lg transition"
          href="/room-gpt/generate"
        >
